...
<body>
    ...
    String tot=session.getAttribute("tpay").toString(); 
String uname="";
String address="";
String city="";
String state="";
...
String avail="";
  ...
  try{
    ...
    while(rs.next()){
      ...
      rs1=st.executeQuery("select * from milkpayment where userid='"+userid+"' and tpay="+tot+"");
 
   
    while(rs1.next()){
         
       sdate=rs1.getString(5);
        edate=rs1.getString(6);
         tmilk=rs1.getString(3);
          tpay=rs1.getString(7);
    }
...
<div id="main">
  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      ...
      <div class="splitnone">
          <form action="download5" method="post" name="ajaxcontactform" id="ajaxcontactform">
          <div align="center"><font size="+1" color="black">DCO-SMS  RECIEPT CUM INVOICE</font><br><br><br>
                <table border="1" width="800" height="200" cellspacing="1" cellpadding="1" align="center">
                    <tbody>
                        <tr>
                            <td>
                                <span ><font size="+1">Name :<input type="hidden"  name="name" value="<%=uname%>"/><%=uname%> </font></span><br>
                            ...
                            <td>
                                <span ><font size="+1">Customer Id:<input type="hidden" name="userid" value="<%=userid%>"/> <%=userid%> </font></span><br>
                         ...
                         <thead height="100" >
                             <tr align="center">
                                 ...
                                 <th><span class="style3"><font size="+1">Total Rupees</font></span></th>
                                  <th><span class="style3"><font size="+1">Avail Balance</font></span></th>
                             </tr>
                         </thead>
                         <tbody height="200">
                             <tr align="center">
                                 <td> <span ><font size="+1"><input type="hidden" name="sdate" value="<%=sdate%>"/> <%=sdate%></font></span></td>
                                 <td> <span ><font size="+1"><input type="hidden" name="edate" value=" <%=edate%>"/><%=edate%></font></span></td>
                                 ...
                                 <td> <span ><font size="+1"><input type="hidden" name="avail" value="<%=avail%>"/><%=avail%> </font></span></td>
                             </tr>
                         </tbody>
                     </table>
