  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      <div class="boxes-padding fullpadding">
        ...
        <form action="viewsalespay1" method="post" name="ajaxcontactform" id="ajaxcontactform">
      <div class="splitnone">
           <fieldset class="row1">
                    
                <legend><font size="6">Daily Milk Sales Payment Details</font>
                </legend>
                <p align="center">
                    <label><font color="black">Date</font> :
                    </label>
                    <input  type="text" name="date" value="" required=""  id="datetimepicker2"/>
