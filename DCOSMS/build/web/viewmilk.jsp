	...
	*/
	...
	(min-device-width: 768px) and (max-device-width: 1024px)  {
		...
		*/
		...
		td:nth-of-type(3):before { content: "Ltr Price"; }
		td:nth-of-type(4):before { content: "Quality"; }
		td:nth-of-type(5):before { content: "Table Rate"; }
  ...
  <div id="main-wrap">
                ...
                <tbody>
                            ...
                            Class.forName("oracle.jdbc.driver.OracleDriver");
                              Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","hr","hr");
                               ...
                               ResultSet rs=st.executeQuery("Select * from milkcollect where date1='"+date+"'");
                               while(rs.next()){
                                   num=1;
                                   String empid=rs.getString(1);
                                   String name =rs.getString(2);
                                   String lprice=rs.getString(4);
                                   String quality=rs.getString(5);
                                   String trate=rs.getString(6);
   ...
   <td > <font color="black"><%=empid%>  </font></td>
     <td><font color="black"><%=name%>  </font></td>
       <td><font color="black"><%=lprice%>  </font></td>
        <td><font color="black"><%=quality%>  </font></td>
        <td><font color="black"><%=trate%>  </font></td>
          ...
          <td><font color="black"><%=total%>  </font></td>
                            ...
                            <%
                              ...
                              {
        if(num==0){
      request.setAttribute("errormessage", "There Are No Milk Collection In This Date");
