  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      <div class="boxes-padding fullpadding">
        ...
        <form action="adminsalesview1" method="post" name="ajaxcontactform" id="ajaxcontactform">
         <div class="splitnone">
               <fieldset class="row1">
                    
                <legend><font size="6">Milk Sales View</font>
                </legend>
                   <p align="center">
                       <label> 
                ...
                <p align="center">
                    ...
                    <input  type="date" name="sdate" required="" id="datetimepicker22"/>
                 ...
                 <p align="center">
                    ...
                    <input  type="date" name="edate" required="" id="datetimepicker23" />
