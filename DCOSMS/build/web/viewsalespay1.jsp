...
<div id="main">
  ...
  <div class="titlesnormal">
      <h1> Current Sales Payment details</h1>
    <span></span> </div>
  <!-- End H1 Title -->
                ...
                <tbody>
                            ...
                            Class.forName("oracle.jdbc.driver.OracleDriver");
                              Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","hr","hr");
                               ...
                               ResultSet rs=st.executeQuery("Select * from salespayment where edate='"+date+"'");
                               while(rs.next()){
                                   num=1;
        ...
        <td><font color="black"><%=sdate%>  </font></td>
          ...
          <td><font color="black"><%=total%>  </font></td>
                            ...
                            <%
                              ...
                              {
        if(num==0){
      request.setAttribute("errormessage", "No Milk Sales Payment In This Date");
