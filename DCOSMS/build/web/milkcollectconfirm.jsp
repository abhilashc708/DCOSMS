  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      <div class="boxes-padding fullpadding">
        ...
        <form name="form1" action="collectmilkconfirm" method="post" id="ajaxcontactform">
       <div class="split2">
          ...
          <fieldset class="row2">
              <legend><font size="6">Person Details</font>
               ...
               <tr>
                   ...
                   <td> <input id="name" type="text" maxlength="3"  class="long"  name="ltrprice"  value="" onkeyup="return calc()" pattern="([0-9])+(?:-?\d){0}" title="price  must digits not character" required=""/><br><br></td>
        ...
        <div class="split2">
          ...
          <fieldset class="row2">
              ...
              <table width="250" height="100" border="0">
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td> <select name="quality" required="" onkeyup="return calc()" >
                      ...
                      <tr>
                          ...
                          <td><select name="trate"  required="" onkeyup="return calc()" >
              ...
              <tr>
                  ...
                  <td><input id="name" type="text" maxlength="3" class="long" name="quantity" required="" value="" onkeyup="return calc()" pattern="([0-9])+(?:-?\d){0}" title="Quality  must digits not character"/><br><br></td>
              </tr>
              <tr>
                  <td>  <label>Total Rs*:
                      </label><br><br></td>
                  <td><input id="total" type="text"  name="total" required="" readonly="" /><br><br></td>
              </tr>
                </tbody>
              </table>
            </fieldset>
