 ...
 <div id="navi">
        <ul>
          ...
          <li><a href="#">Milk Details</a>
           ...
           <li><a href="#" class="current">Admin Manage</a>
                <ul>
  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      <div class="boxes-padding fullpadding">
        ...
        <form action="adminreg" method="post" name="ajaxcontactform" id="ajaxcontactform">
         <div class="splitnone">
               <fieldset class="row1">
                    
                <legend><font size="6">Admin Register </font>
                </legend>
                   <p align="center">
                       <label> 
                ...
                <p align="center">
                    ...
                    <input  type="text" name="id" value="admin<%=generaterandomnumber(1000,9999)%>" required="" />
                    
                </p>
                <p align="center">
                    
                    <label><font color="black">Ad: Name </font> :
                    </label>
                    <input  type="text" name="name" required="" pattern="[A-Za-z]{5,15}" title="Name must be character not digits and legth between 5 to 15 and whitespace not allowed"/>
             ...
             <div>
                     <p align="center"> <input type="submit" class="smallrounded blackbutton"  name="update" value="Register"/>
                         </p></div> 
