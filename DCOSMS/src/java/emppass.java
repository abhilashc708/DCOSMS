 ...
 * @author Abhilash
 */
public class emppass extends HttpServlet {
        ...
        try {
              Class.forName("oracle.jdbc.driver.OracleDriver");
                ...
                Statement st=con.createStatement();
                  ...
                  String query="update empreg set pass='"+pass1+"' where empid='"+uid+"'and pass='"+pass+"'";
                  if(st.executeUpdate(query)>0){
                    
                        request.setAttribute("errormessage", "Change Password Succsessfully Completed Relogin Now");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet emppass</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet emppass at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
