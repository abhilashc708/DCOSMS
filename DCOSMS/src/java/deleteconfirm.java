    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                Statement st=(Statement) con.createStatement();
                  ...
                  String query="delete from empreg where empid='"+empid+"'";
                 if(st.executeUpdate(query)>0){
                      
                        request.setAttribute("errormessage", "Employee Deletion Succsessfully Completed");
                  ...
                  {
                      request.setAttribute("errormessage", "Not Valid Employee ID");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet deleteconfirm</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet deleteconfirm at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
