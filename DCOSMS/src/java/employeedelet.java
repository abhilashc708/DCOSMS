 ...
 * @author Abhilash
 */
public class employeedelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet employeedelet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet employeedelet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
