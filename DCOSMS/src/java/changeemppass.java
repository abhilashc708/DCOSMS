    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(eid!= null)
         {
              ...
              request.getRequestDispatcher("/changeemppass.jsp").forward(request, response);
         }
        ...
        else
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet changeemppass</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet changeemppass at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
