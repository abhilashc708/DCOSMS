        ...
        try {
              Class.forName("oracle.jdbc.driver.OracleDriver");
                ...
                Statement st=con.createStatement();
                  ...
                  String query="insert into admin(id,name,pass) values('"+id+"','"+name+"','"+pass+"')";
                  if(st.executeUpdate(query)>0){
                      
                        request.setAttribute("errormessage", "New Admin Registration Succsessfully Completed");
         
                         getServletContext().getRequestDispatcher("/regadmin.jsp").forward(request, response);
                  ...
                  {
                      request.setAttribute("errormessage", "Admin Registration Failed");
