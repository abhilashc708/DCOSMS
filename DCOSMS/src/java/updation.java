    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
                ...
                Statement st=con.createStatement();
                  ...
                  String query="update empreg set phone="+phone+",salary="+salary+" where empid='"+empid+"'";
                  if(st.executeUpdate(query)>0){
                    
                        request.setAttribute("errormessage", "Employee Updation Succsessfully Completed");
                ...
                else
                  {
                      ...
                      request.setAttribute("errormessage", "Employee Updation Failed");
