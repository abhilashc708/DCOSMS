                              ...
                              Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","hr","hr");
                               ...
                               while(rs.next()){
                                   ...
                                   String state=rs.getString(9);
                                    String animal=rs.getString(10);
                                     String sex=rs.getString(11);
                                      String day=rs.getString(12);
                                       String month=rs.getString(13);
                                        String year=rs.getString(14);
                                         String national=rs.getString(15);
      ...
      <td><font color="black"><%=name%>  </font></td>
       <td><font color="black"><%=phone%>  </font></td>
        ...
        <td><font color="black"><%=address%>  </font></td>
          ...
          <td><font color="black"><%=animal%>  </font></td>
           ...
           <td><font color="black"><%=day%>  </font></td>
            ...
            <td><font color="black"><%=national%>  </font></td> 
                            ...
                            <%
                              ...
                              {
        if(num==0){
      request.setAttribute("errormessage", "There Are No Customers");
