...
<div id="main">
  ...
  <div class="titlesnormal">
      <h1> Current Milk Sales details</h1>
    <span></span> </div>
  <!-- End H1 Title -->
		...
		<tr>
			...
			<th>Total</th>
                ...
                <tbody>
                            ...
                            Class.forName("oracle.jdbc.driver.OracleDriver");
                              Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","hr","hr");
                               ...
                               ResultSet rs=st.executeQuery("Select * from milksales where date1='"+date+"'");
                               while(rs.next()){
                                   num=1;
                ...
                %>
                             ...
                             <tr>
   <td > <font color="black"><%=custid%>  </font></td>
       ...
       <td><font color="black"><%=lprice%>  </font></td>
          ...
          <td><font color="black"><%=total%>  </font></td>
                            ...
                            <%
                              ...
                              {
        if(num==0){
      request.setAttribute("errormessage", "There Are No Milk Sales In This Date");
