	...
	*/
	...
	(min-device-width: 768px) and (max-device-width: 1024px)  {
		...
		*/
		...
		td:nth-of-type(3):before { content: "Total Milk"; }
		td:nth-of-type(4):before { content: "Total Amount"; }
		td:nth-of-type(5):before { content: "Start Date"; }
		td:nth-of-type(6):before { content: "End Date"; }
		td:nth-of-type(7):before { content: "Current Pay"; }
...
<div id="main">
  ...
  <div class="titlesnormal">
      <h1> Current Purchase Payment details</h1>
    <span></span> </div>
  <!-- End H1 Title -->
                ...
                <tbody>
                            ...
                            Class.forName("oracle.jdbc.driver.OracleDriver");
                              Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","hr","hr");
                               ...
                               ResultSet rs=st.executeQuery("Select * from milkpayment where edate='"+date+"'");
                               while(rs.next()){
                                   num=1;
     ...
     <td><font color="black"><%=name%>  </font></td>
       <td><font color="black"><%=tmilk%>  </font></td>
        ...
        <td><font color="black"><%=sdate%>  </font></td>
          ...
          <td><font color="black"><%=avail%>  </font></td>
                            ...
                            <%
                              ...
                              {
        if(num==0){
      request.setAttribute("errormessage", "No Milk Purchase Payment In This Date");
