...
<div id="main">
  ...
  <div class="titlesnormal">
      <h1> Deactivation Of Employees</h1>
    <span></span> </div>
  <!-- End H1 Title -->
  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      <div class="boxes-padding fullpadding">
        ...
        <form action="deleteconfirm" method="post" name="ajaxcontactform" id="ajaxcontactform">
      <div class="splitnone">
           <fieldset class="row1">
                    
                <legend><font size="6">Employee Deletion</font>
                </legend>
                   <p align="center">
                       <label> 
             ...
             <div>
                     <p align="center"> <input type="submit" class="smallrounded blackbutton"  name="delete" value="Delete"/>
                         </p></div> 
