  ...
  <div id="main-wrap">
    ...
    <div class="boxes-full">
      <div class="boxes-padding fullpadding">
        ...
        <form action="milksalesconfirm" method="post" name="ajaxcontactform" id="ajaxcontactform">
      <div class="splitnone">
           <fieldset class="row1">
                    
                <legend><font size="6">Daily Milk Sales</font>
                </legend>
                  <p>
                ...
                <p align="center">
                    ...
                    <input  type="text" name="userid" value="cust<%=generaterandomnumber(100000,999999)%>" readonly=""/>
                    
                </p>
                 <p align="center">
                    <label><font color="black">Name</font> :
                    </label>
                    <input  type="text" name="name" value="" required="" pattern="[A-Za-z]{5,15}" title="Name must be character not digits and legth between 5 to 15 and whitespace not allowed" />
                    
                </p>
                 <p align="center">
                    <label><font color="black">Price</font> :
                    </label>
                     <input  type="text" maxlength="3" name="price" value="" required="" pattern="([0-9])+(?:-?\d){0}" title="price  must be  digits not character" />
